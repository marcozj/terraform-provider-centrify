data "centrify_passwordprofile" "checkpoint_pw_pf" {
    name = "Check Point Gaia Profile"
}

# TODO: administrative_account_id setting
resource "centrify_system" "checkpoint2" {
    ...
    password_profile_id = data.centrify_passwordprofile.checkpoint_pw_pf.id
