resource "centrify_system" "genericssh2" {
    # System -> Settings menu related settings
    name = "Demo Generic SSH 2"
    fqdn = "192.168.2.4"
    computer_class = "GenericSsh"
    session_type = "Ssh"
    description = "Demo Generic SSH 2"
    port = 22
    system_timezone = "UTC"
    ...
    //password_profile_id = data.centrify_passwordprofile.unix_pw_pf.id
