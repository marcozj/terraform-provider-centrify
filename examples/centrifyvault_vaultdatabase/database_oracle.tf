data "centrifyvault_passwordprofile" "oracle_pw_pf" {
  name = "Oracle Database Profile"
}

resource "centrifyvault_vaultdatabase" "oracledb" {
  ...
  password_profile_id                    = data.centrifyvault_passwordprofile.oracle_pw_pf.id
