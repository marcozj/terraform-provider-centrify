data "centrifyvault_passwordprofile" "ciscoios_pw_pf" {
    name = "Cisco IOS Profile"
}

resource "centrifyvault_vaultsystem" "ciscoios2" {
    # System -> Settings menu related settings
    name = "Demo CiscoIOS 2"
    fqdn = "192.168.2.4"
    computer_class = "CiscoIOS"
    session_type = "Ssh"
    description = "Demo CiscoIOS 2"
    port = 22
    system_timezone = "UTC"
    ...
    password_profile_id = data.centrifyvault_passwordprofile.ciscoios_pw_pf.id
