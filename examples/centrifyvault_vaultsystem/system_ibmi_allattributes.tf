data "centrifyvault_passwordprofile" "ibmi_pw_pf" {
    name = "IBM i Profile"
}

resource "centrifyvault_vaultsystem" "ibmi2" {
    ...
    password_profile_id = data.centrifyvault_passwordprofile.ibmi_pw_pf.id
