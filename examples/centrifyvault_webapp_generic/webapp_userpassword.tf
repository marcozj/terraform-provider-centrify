...
resource "centrifyvault_webapp_generic" "userpasswordapp" {
    name = "Test UserPassword App"
    template_name = "Generic User-Password"
    description = "Test UserPassword Application"
